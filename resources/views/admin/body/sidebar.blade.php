        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/blog') ? 'active' : '' }}">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'post.view') ? 'active' : '' }}"><a href="{{ route('post.view') }}"><i class="ti-more"></i>List Blog Post</a></li>
            ...
            <li class="treeview {{ ($prefix == '/return') ? 'active' : '' }}">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'return.all.request') ? 'active' : '' }}"><a href="{{ route('return.all.request') }}"><i class="ti-more"></i>All Request</a></li>
            ...
            @if($blog == true)
                <li class="treeview {{ ($prefix == '/post') ? 'active' : '' }}">
                    <a href="#">
                        <i data-feather="file"></i>
                        <span>Manage Post Comments</span>
                        <span class="pull-right-container">
                        <i class="fa fa-angle-right pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li class="{{ ($route == 'pending.comment') ? 'active' : '' }}"><a href="{{ route('pending.comment') }}"><i class="ti-more"></i>Pending Comments</a></li>
                        <li class="{{ ($route == 'approved.comment') ? 'active' : '' }}"><a href="{{ route('approved.comment') }}"><i class="ti-more"></i>Approved Comments</a></li>
