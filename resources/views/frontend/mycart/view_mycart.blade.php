                    ...
                    <div class="shopping-cart-table ">
                        <div class="table-responsive">
                            <table class="table text-center">
                                ...
                                <tbody id="cartPage">
                                {{--    Data will coming form ajax here--}}
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="form-control unicase-form-control text-input" name="coupon_name" id="coupon_name" placeholder="You Coupon..">
                                            @error('coupon_name')
                    ...
                    <div class="col-md-4 col-sm-12 cart-shopping-total">
                        <table class="table">
                            <thead id="couponCalField">
                                ...
                                <!-- data from ajax to display here -->
