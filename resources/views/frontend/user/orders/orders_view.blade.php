                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td class="col-md-1">
                                        ...
                                        <a href="{{ url('user/invoice_download/'.$order->id) }}" target="_blank" class="btn btn-sm btn-danger" style="margin-top: 5px"><i class="fa fa-download" style="color: white;"></i> Invoice </a>
