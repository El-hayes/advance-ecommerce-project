                        ...
                        <div class="sidebar-module-container">
                            <div class="sidebar-filter">
                                ...
                                <div class="sidebar-widget wow fadeInUp">
                                    <h3 class="section-title">@if(session()->get('language') == 'en') shop by @else التسوق حسب @endif </h3>
                                    <div class="widget-header">
                                        <h4 class="widget-title">@if(session()->get('language') == 'en') Category @else القسم @endif </h4>
                                    </div>
                                            ...
                                            @endif
                                                ...
                                                {{--@php
                                                    ...
                                                    if(request()->has('category')){
                                                        $filterCat = explode(',', request('category'));
                                                    }
                                                @endphp--}}
                                                    ...
                                                    <div class="accordion-heading">
                                                            ...
                                                            <label class="form-check-label">
                                                                <input type="checkbox" class="form-check-input"  name="category[]"
                                                                    ...
                                                                    {{ in_array($category->category_slug_en, $filterCat ?? []) ? 'checked' : '' }}>

                                                                {{ (session()->get('language') == 'en') ? $category->category_name_en : $category->category_name_ar }}
                                                            </label>
                                ...
                                <div class="sidebar-widget wow fadeInUp">
                                    <div class="widget-header">
                                        <h4 class="widget-title">@if(session()->get('language') == 'en') Brand Filter @else فلتر العلامة التجارية @endif </h4>
                                    </div>
                                    <div class="sidebar-widget-body">
                                        <div class="accordion">
                                            ...
                                            {{--@php
                                                ...
                                                if(request()->has('brand')){
                                                    $filterBrand = explode(',', request('brand'));
                                                }
                                            @endphp--}}
                                                    ...
                                                    <div class="accordion-heading">
                                                        ...
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input"  name="brand[]"
                                                                ...
                                                                {{ in_array($brand->brand_slug_en, $filterBrand ?? []) ? 'checked' : '' }}>

                                                            {{ (session()->get('language') == 'en') ? $brand->brand_slug_en : $brand->brand_slug_ar }}
                                                        </label>
