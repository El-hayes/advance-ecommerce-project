        ...
        <div class='container'>
            <div class='row'>
                                    ...
                                    <div class="accordion">
                                        ...
                                        @foreach($categories as $category)
                                            <div class="accordion-group">
                                                <div class="accordion-heading"> <a href="#collapseOne{{ $category->id }}" data-toggle="collapse" class="accordion-toggle collapsed"> @if(session()->get('language') == 'en') {{ $category->category_name_en }} @else {{ $category->category_name_ar }} @endif </a> </div>
                                                <!-- /.accordion-heading -->
                ...
                <div class='col-md-9'>
                    ...
                    <h4><b>Total Search </b> <span class="badge badge-pill badge-danger" style="background: #FF0000;">{{ count($products) }}</span> Items</h4>
