                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped text-center">
                                    ...
                                    @foreach($adminuser as $item)
                                        <tr>
                                            <td> <img src="{{ (!empty($item->profile_photo_path)) ? url($item->profile_photo_path) : url('upload/no_image.jpg') }}" style="width: 50px; height: 50px;">  </td>
                                            <td> {{ $item->name }}  </td>
                                            <td> {{ $item->email  }}  </td>
                                            ...
                                            <td>
                                                ...
                                                @if($item->blog == 1)
                                                    <span style="color: #212529" class="badge btn-warning">Blog</span>
                                                @else
                                                @endif
                                                ...
                                                @if($item->reports == 1)
                                                    <span style="color: #212529" class="badge btn-warning">Reports</span>
                                                @else
                                                @endif
                                            ...
                                            <td width="25%">
                                                <a href="{{ route('admin.user.edit',$item->id) }}" class="btn btn-info" title="Edit Data"><i class="fa fa-pencil"></i> </a>

                                                <a  href="{{ route('admin.user.delete',$item->id) }}" class="btn btn-danger" title="Delete" id="delete">
