                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <img id="showImage" src="{{ !empty($adminUser->profile_photo_path) ? url($adminUser->profile_photo_path) : url('upload/no_image.jpg') }}" style="width: 100px; height: 100px;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_15" name="alluser" value="1" {{ ($adminUser->allusers == 1) ? 'checked' : '' }}>
