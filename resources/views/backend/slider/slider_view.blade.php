                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($sliders as $slider)
                                        <tr>
                                            <td><img src="{{ asset($slider->slider_img) }}" alt="slider_img" width="70px" height="40px"></td>
                                            <td>
                                            ...
                                            <td class="btn-adjust" style="width: 30%">
                                                <a href="{{ route('slider.edit', $slider->id) }}" class="btn btn-info btn-sm" title="Edit Data"><i class="fa fa-pencil"></i></a>
                                                <a href="{{ route('slider.delete' , $slider->id) }}" class="btn btn-danger btn-sm" title="Delete Data" id="delete"><i class="fa fa-trash"></i></a>
                                                @if($slider->status == 1)
                            ...
                            <div class="table-responsive">
                                <form method="POST" action="{{ route('slider.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="slider_title" name="slider_title"  class="form-control"> <div class="help-block"></div></div>
                                        @error('slider_title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="slider_description" name="slider_description"  class="form-control"> <div class="help-block"></div></div>
