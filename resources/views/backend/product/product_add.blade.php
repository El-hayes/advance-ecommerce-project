...
@section('admin')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 2nd row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_name_ar" class="form-control" value="{{ old('product_name_ar') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_en" class="form-control"
                                                               value="{{ old('product_tags_en', 'Electronics,Mobiles,Communications') }}" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_ar" class="form-control"
                                                               value="{{ old('product_tags_ar', 'الكترونيات,موبايلات,اتصالات') }}" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_en" class="form-control"
                                                               value="{{ old('product_size_en', 'Small,Medium,Large') }}"  data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_ar" class="form-control"
                                                               value="{{ old('product_size_ar', 'صغير,وسط,كبير') }}" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_en" class="form-control"
                                                               value="{{ old('product_color_en', 'red,Black,ًWhite') }}" data-role="tagsinput">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_color_ar" class="form-control"
                                                               value="{{ old('product_color_ar', 'احمر,اسود,ابيض') }}" data-role="tagsinput">
                                        ...
                                        <div class="row"> <!-- start 6th row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="file" name="multi_img[]" multiple class="form-control" id="multiImg">
                                                        @error('multi_img')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                        ...
                                        <div class="row"> <!-- start 7th row  -->
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="short_descp_en" id="textarea" class="form-control" placeholder="Write short description here...">{{ old('short_descp_en') }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="short_descp_ar" id="textarea" class="form-control" placeholder="اكتب وصف قصير هنا...">{{ old('short_descp_ar') }}</textarea>
                                        ...
                                        <div class="row"> <!-- start 8th row  -->
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
	                                                    <textarea id="editor1"  name="long_descp_en" rows="10" cols="80" >{{ old('long_descp_en', 'Write Long description here...') }}</textarea>
                                                        @error('long_descp_en')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
	                                                    <textarea id="editor2"  name="long_descp_ar" rows="10" cols="80" >{{ old('long_descp_ar' , 'اكتب وصف طويل هنا...') }}</textarea>
                                                        @error('long_descp_ar')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <h5>Digital Product <span class="text-danger">pdf, doc, docx, xls, xlsx, zip</span></h5>
                                                <div class="controls">
    ...
    <!-- display multiple img after selected -->
    <script>
